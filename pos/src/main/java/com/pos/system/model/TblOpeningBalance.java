...
/**
 * TblOpeningBalance generated by hbm2java
 */
public class TblOpeningBalance implements java.io.Serializable {
	...
	public TblOpeningBalance() {
	}

	public TblOpeningBalance(TblEmployee tblEmployee, Date datDate, float fltAmount) {
